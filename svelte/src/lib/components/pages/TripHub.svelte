...
{#if editModal}
  <div class="fixed inset-0 z-50 flex items-center justify-center"
    style="background:rgba(0,0,0,.52);backdrop-filter:blur(5px)" role="dialog" aria-modal="true">
    <div class="w-full max-w-sm mx-4 rounded-2xl border shadow-2xl overflow-hidden"
      ...
      <div class="px-5 py-4 border-b flex items-center justify-between"
        ...
        <button onclick={closeEditModal} class="text-lg leading-none hover:opacity-60"
          style="color:var(--ws-muted)">✕</button>
      </div>

      <div class="p-5 space-y-4">

        <!-- Feld 1: Kosmetischer Titel -->
        ...
        <!-- Feld 2: Ort / Hauptziel mit Geocode-Autocomplete -->
        <div class="space-y-1.5">
          <label class="text-xs font-semibold" style="color:var(--ws-muted)">
