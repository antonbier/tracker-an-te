...
{#if open}
  ...
  <div class="fixed inset-0 md:inset-[4vh_auto] md:left-1/2 md:-translate-x-1/2 md:w-full md:max-w-4xl md:max-h-[92vh] md:rounded-2xl z-50 flex flex-col shadow-2xl overflow-hidden"
